...
[youtube https://youtu.be/EJoBrAFjsa8]

### Further Reading

For more info, check out the following links:

* The [official plugin page](https://www.gloriafood.com/wordpress-restaurant-plugin)
* The [GloriaFood website](https://www.gloriafood.com/)
* [Reviews from restaurant owners](https://www.gloriafood.com/reviews)
* GloriaFood on [Facebook](https://facebook.com/gloriafood), [Twitter](https://twitter.com/gloriafood) and [YouTube](https://www.youtube.com/gloriafood)

== Installation ==

=== How to install and activate the plugin ===

Please see our [step by step instructions guide](https://www.gloriafood.com/restaurant-ideas/add-online-ordering-button-wordpress) on how to install and use this plugin.

**From within WordPress**

1. Go to `Plugins > Add New`
1. Search by Author for GloriaFood
...
1. Go to `Dashboard` and set up the restaurant profile
1. Insert the food menu
1. Use the shortcodes to publish the ordering and table reservation buttons on your website
1. Use the menu shortcode to publish your online menu on any page of your website
1. You can start taking online orders and table reservations!
...
Please see the complete guide [here](https://www.gloriafood.com/how-to-print-restaurant-receipts).
...
1. Example of website using this plugin
2. Example of the ordering widget on a live website
3. Example of the table reservation widget on a live website
4. The restaurant setup - adding delivery areas
5. The restaurant setup - selecting the cuisines
6. The restaurant setup - table reservations
7. Easy installation of the restaurant app
8. The restaurant menu editor
9. Shortcodes for publishing the buttons and food menu
