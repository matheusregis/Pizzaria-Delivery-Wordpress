            ...
            <div class="container">
                <div class="row title-row">
                    <div class="col-10 col-offset-1 text-center">
                        ...
                        <a class="btn-green btn js-autologin-admin" href="<?= $this->get_glf_mor_token();?>&r=app.admin.setup" target="_blank"> <?= __('Open the Full Admin Panel', 'menu-ordering-reservations');?> </a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="feature">
                            ...
                            <div class="feature-description">
                                ...
                                <a class="js-autologin-reports" href="<?= $this->get_glf_mor_token();?>&r=app.admin.reports.essentials.analytics_overview" target="_blank"> <?= __('Access the reports', 'menu-ordering-reservations');?> </a>
                            </div>
                        </div>
                        <div class="feature">
                            ...
                            <div class="feature-description">
                                ...
                                <a class="js-autologin-tracking" href="<?= $this->get_glf_mor_token();?>&r=app.admin.other.integrations.gtm" target="_blank"> <?= __('Set up tracking', 'menu-ordering-reservations');?> </a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="feature">
                            ...
                            <div class="feature-description">
                                ...
                                <a class="js-autologin-online-payments" href="<?= $this->get_glf_mor_token();?>&r=app.admin.setup.online.services.index" target="_blank"> <?= __('Enable online payments', 'menu-ordering-reservations');?> </a>
                            </div>
                        </div>
                        <div class="feature">
                            ...
                            <div class="feature-description">
                                ...
                                <a class="js-autologin-promotions" href="<?= $this->get_glf_mor_token();?>&r=app.admin.marketing.promotions.overview" target="_blank"> <?= __('Access the promotions', 'menu-ordering-reservations');?> </a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="feature">
                            ...
                            <div class="feature-description">
                                ...
                                <a class="js-autologin-fb-ordering" href="<?= $this->get_glf_mor_token();?>&r=app.admin.setup.publishing.facebook_installation" target="_blank"> <?= __('Install the App', 'menu-ordering-reservations');?> </a>
                            </div>
                        </div>
                        <div class="feature">
                            ...
                            <div class="feature-description">
                                ...
                                <a class="js-autologin-apps" href="<?= $this->get_glf_mor_token();?>&r=app.admin.setup.publishing.wla.info" target="_blank"> <?= __('Get started', 'menu-ordering-reservations');?> </a>
                            </div>
                        </div>
                    </div>
                </div>
